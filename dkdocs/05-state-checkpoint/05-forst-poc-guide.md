...
- FileSystem 추상 + S3 multipart (ForSt가 사용하는 layer): [`../07-filesystem-checkpoint-store/`](../07-filesystem-checkpoint-store/)
- Source/Sink V2 SPI (Iceberg/Kafka 매핑): [`../06-source-sink-spi/`](../06-source-sink-spi/)
